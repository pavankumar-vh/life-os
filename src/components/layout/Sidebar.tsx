...
import {
  ...
  DollarSign, BookMarked, Droplets, LinkIcon, Heart, FolderKanban, Brain, Gift, Zap
} from 'lucide-react'
          ...
          {!sidebarCollapsed && (
            ...
            >
              <motion.div
                ...
                whileHover={{ scale: 1.05, boxShadow: '0 0 24px -4px rgba(232, 213, 183, 0.25)' }}
              >
            ...
            return (
              <motion.button
                ...
                style={isActive ? {
                  ...
                  boxShadow: '0 0 20px -4px rgba(232, 213, 183, 0.1), inset 0 1px 0 rgba(255, 255, 255, 0.05)',
                } : {}}
                whileHover={!isActive ? {
              ...
              >
                {isActive && (
                  <motion.div
                    ...
                    style={{
                      ...
                      boxShadow: '0 0 12px rgba(232, 213, 183, 0.4)',
                    }}
                ...
                {!sidebarCollapsed && (
                  <>
                    ...
                    <span className="text-[10px] opacity-0 group-hover:opacity-100 transition-all duration-200 text-text-muted">
                      {item.shortcut}
                    </span>
                  </>
                )}
