    ...
    <div>
      ...
      <div className="grid grid-cols-3 gap-3 mb-8">
        ...
        <div className="card text-center">
          ...
          <p className="text-[10px] text-text-muted">Pomodoros</p>
        </div>
      </div>
      ...
      <div className="flex flex-col items-center mb-8">
        ...
        <div className="flex items-center gap-4 mt-8">
          ...
          <button onClick={isRunning ? pauseTimer : startTimer}
            className={`w-16 h-16 rounded-full flex items-center justify-center text-bg font-medium transition-all ${
      ...
      {sessionsToday > 0 && (
        <div className="card">
          ...
          <p className="text-[10px] text-text-muted mt-3">{sessionsToday} sessions · {totalFocusMinutes} minutes of deep focus</p>
        </div>
      )}
