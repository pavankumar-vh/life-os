    ...
    <div>
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-text-muted text-xs mt-0.5">{logs.length} entries logged</p>
        </div>
      ...
      {stats && (
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-6">
          <div className="card text-center">
            ...
            <p className="text-[10px] text-text-muted">Current Weight (kg)</p>
          </div>
          <div className="card text-center">
            ...
            <p className="text-[10px] text-text-muted">vs Last Entry (kg)</p>
          </div>
          <div className="card text-center">
          ...
          <div className="card text-center">
            ...
            <p className="text-[10px] text-text-muted">Total Change (kg)</p>
          </div>
        </div>
      )}
          ...
          <div className="flex items-end gap-1 h-24">
            {weightHistory.map((d, i) => (
              <div key={i} className="flex-1 flex flex-col items-center gap-1">
                <span className="text-[8px] text-text-muted">{d.weight}</span>
